...
void    num2asc_s32(i32 data, u8 *buf, u8 flags);
inline void num2asc_i32(u8 *buf, i32 n, u8 w, u8 p, u8 bcd, u8 nozeros){ NUM2ASC_s32(n, buf, w,p, bcd,nozeros); }

// calculate number width
inline u8 width_i32(i32 n){
	u8 s = 0;
	if (n < 0){ s = 1; n = -n; }
